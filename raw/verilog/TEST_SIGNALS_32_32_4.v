...
begin: WRITE_TASK
	...
	@ (posedge clk) begin
		TEST_SIGNALS_32_32_4.X_ADDRESS_IN <= X_ADDRESS_IN;
		TEST_SIGNALS_32_32_4.Y_ADDRESS_IN <= Y_ADDRESS_IN;
		TEST_SIGNALS_32_32_4.EN <= 1;
		TEST_SIGNALS_32_32_4.RW <= 0;
		TEST_SIGNALS_32_32_4.Z_WR <= VALUE;
	end
	@ (posedge clk) begin
		TEST_SIGNALS_32_32_4.EN <= 0;		
	end	
	@ (negedge clk) begin
		TEST_SIGNALS_32_32_4.Z_WR <= {B_SIZE{1'bz}};
	end
end
endtask
